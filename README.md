# [IEEE T-IP] Through the Looking Glass: A Dual Perspective on Weakly-Supervised Few-Shot Segmentation
...
[June 22, 2026]： TLG is accepted by IEEE Transactions on Image Processing (IEEE T-IP).
