...
class FSSDataset:
    ...
    @classmethod
    def build_dataloader(cls, benchmark, bsz, nworker, fold, split, shot=1, cam_train_path=None, cam_val_path=None):
        ...
        dataset = cls.datasets[benchmark](cls.datapath, fold=fold, transform=cls.transform, split=split,
                                          ...
                                          cam_train_path=cam_train_path, cam_val_path=cam_val_path)
