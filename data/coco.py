...
class DatasetCOCO(Dataset):
    ...
    def __len__(self):
        return len(self.img_metadata) if self.split == 'trn' else 5000
    ...
    def __getitem__(self, idx):
        ...
        # pse mask
        query_pse_mask_path = self.cam_path + query_name[:-3] + 'png'
        ...
        for nn in range(nshot):
            ...
            support_pse_mask_path = self.cam_path + support_names[nn][:-3] + 'png'
